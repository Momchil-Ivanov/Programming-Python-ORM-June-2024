...
class BrandsChoices(models.TextChoices):
    ASUS = 'Asus', 'Asus'
    ACER = 'Acer', 'Acer'
    APPLE = 'Apple', 'Apple'
...
class Laptop(models.Model):
    brand = models.CharField(max_length=20, choices=BrandsChoices)
    ...
    operation_system = models.CharField(max_length=100, choices=OperatingSystemChoices)
    price = models.DecimalField(max_digits=10, decimal_places=2)
