...
class BaseReservation(models.Model):
    ...
    def reservation_period(self) -> int:
        reservation_period_in_days = (self.end_date - self.start_date).days
        return reservation_period_in_days
    ...
    def clean(self) -> None:
        if self.start_date >= self.end_date:
            raise ValidationError(f"Start date cannot be after or in the same end date")
